        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Customer</h5>
                    <a href="<?= BASE_URL ?>customers" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left"></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL ?>customers/<?= $customer['id'] ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="owner_name" 
                                           value="<?= htmlspecialchars($customer['owner_name'] ?? '') ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="address" rows="3" required><?= htmlspecialchars($customer['address']) ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="customer_type">
                                        ...
                                        <option value="distributor" <?= $customer['customer_type'] == 'distributor' ? 'selected' : '' ?>>Distributor</option>
                                        <option value="other" <?= $customer['customer_type'] == 'other' ? 'selected' : '' ?>>Lainnya</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="customer_category" 
                                           value="<?= htmlspecialchars($customer['customer_category'] ?? '') ?>"
                                    ...
                                    <select class="form-select" name="assigned_marketing_id">
                                        ...
                                        <?php foreach ($marketingList ?? [] as $marketing): ?>
                                            <option value="<?= $marketing['id'] ?>" 
                                                    <?= ($customer['assigned_marketing_id'] ?? '') == $marketing['id'] ? 'selected' : '' ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="latitude" 
                                           id="latitude" value="<?= $customer['latitude'] ?? '' ?>"
                                           placeholder="-6.2088">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="longitude" 
                                           id="longitude" value="<?= $customer['longitude'] ?? '' ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="notes" rows="3"><?= htmlspecialchars($customer['notes'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
