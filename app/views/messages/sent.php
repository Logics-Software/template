            ...
            <div class="form-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-2">
                        <form method="GET" action="<?php echo APP_URL; ?>/messages/sent" class="d-flex" id="searchForm">
                            <div class="input-group">
                                <input type="text" name="search" class="form-control" placeholder="Cari pesan terkirim..." value="<?php echo htmlspecialchars($search ?? ''); ?>" id="searchInput">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 min-w-80">
                                                <a href="<?php echo APP_URL; ?>/messages/<?php echo $message['id']; ?>" class="btn btn-info btn-sm btn-action" 
                                                data-bs-toggle="tooltip" data-bs-title="Lihat Pesan">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm btn-action" onclick="deleteMessage(<?php echo $message['id']; ?>)" 
